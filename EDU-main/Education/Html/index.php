...
<body>
        ...
        <div class="container">
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-center flex-grow-1 pe-3">
                        ...
                        <li class="nav-item">
                        <a class="nav-link mx-lg-2 " href="http://localhost/EDU-main/EDU-main/Education/Login&Questions/Questions/allQuestions.php">Questions</a>
                        </li>   
                        <!-- dropdown -->
            ...
            <ul class='username-flex'>
                ...
                <li>
                    ...
                    ?>
                        <a href="http://localhost/EDU-main/EDU-main/Education/Login&Questions/Login_system/3-login_form.php">
    ...
    this is your space to seek advice and share insights. Join our community and let's learn together!</p>
                    <a href="http://localhost/EDU-main/EDU-main/Education/Login&Questions/Questions/1-index.php" class="btn third" ><span> Questions welcome! </span></a>
                </div>
                <!-- media -->
                <div class=" media">
                  <ul>
